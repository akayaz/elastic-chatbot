...
# streamlit UI Config
st.set_page_config(page_title="Question answering", page_icon=":cinema:", initial_sidebar_state="collapsed")
st.image(
...
class QAMovieBot:
    ...
    def main(self):
        ...
        # default query
        default_query = ('Quelle est la démarche qualité de l AIFE ?')
        # Main chat form
            ...
            with st.chat_message("Assistant"):
                ...
                with st.container():
                    for docs_source in resp['response']['context']:
                        ...
                        st.markdown(link + " url: %s " % (docs_source.metadata["url"]),
